#!/usr/bin/env python3
"""Deleta as threads grandes do Catalog Enricher (COLLECTION_THREADS_DELETE)."""
import os, time, json
...
with Camoufox(headless=False, humanize=True, os=("linux",)) as browser:
    ...
    try:
        ...
        print("[del2] restantes:", json.dumps(out, ensure_ascii=False))
    except Exception as e:
        print("[del2] list fail:", e)
    ctx.close()
print("[del2] fim")
