...
try {
  ...
  const expected = ['lookup_ean', 'search_images', 'enrich_product', 'validate_listing', 'enrich_batch', 'analyze_url', 'analyze_image', 'fetch_product_images', 'prepare_shopify_payload', 'ocr_image'];
